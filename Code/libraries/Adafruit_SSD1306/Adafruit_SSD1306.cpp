...
/*!
    ...
    @param  twi
            Pointer to an existing i2c_t3 instance (e.g. &Wire, the
...
*/
Adafruit_SSD1306::Adafruit_SSD1306(uint8_t w, uint8_t h, i2c_t3 *twi,
...
/*!
    ...
    @param  periphBegin
            ...
            (e.g. a i2c_t3 interface on non-default pins, as can be done
...
bool Adafruit_SSD1306::begin(uint8_t vcs, uint8_t addr, bool reset,
  ...
  if (wire) { // Using I2C
    ...
    // i2c_t3 begin() function might be already performed by the calling
