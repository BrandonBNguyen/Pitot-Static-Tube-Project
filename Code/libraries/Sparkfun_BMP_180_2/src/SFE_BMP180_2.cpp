...
SFE_BMP180_2::SFE_BMP180_2()
// Base library type
{
}


char SFE_BMP180_2::begin()
// Initialize library for subsequent pressure measurements
{
	double c3,c4,b1;
	
	// Start up the Arduino's "Wire1" (I2C) library:
...
char SFE_BMP180_2::readInt(char address, int16_t &value)
...
char SFE_BMP180_2::readUInt(char address, uint16_t &value)
...
char SFE_BMP180_2::readBytes(unsigned char *values, char length)
...
// length: number of bytes to read
{
	...
	Wire1.beginTransmission(BMP180_ADDR);
	Wire1.write(values[0]);
	_error = Wire1.endTransmission();
	if (_error == 0)
	{
		Wire1.requestFrom(BMP180_ADDR,length);
...
char SFE_BMP180_2::writeBytes(unsigned char *values, char length)
...
char SFE_BMP180_2::startTemperature(void)
...
char SFE_BMP180_2::getTemperature(double &T)
...
char SFE_BMP180_2::startPressure(char oversampling)
...
char SFE_BMP180_2::getPressure(double &P, double &T)
...
double SFE_BMP180_2::sealevel(double P, double A)
...
double SFE_BMP180_2::altitude(double P, double P0)
...
char SFE_BMP180_2::getError(void)
	// If any library command fails, you can retrieve an extended
	// error code using this command. Errors are from the Wire1 library: 
	// 0 = Success
